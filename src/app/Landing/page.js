                    ...
                    <div className="w-full navbar bg-green-800">
                        <div className="flex-none lg:hidden">
                            <label htmlFor="my-drawer-3" className="btn btn-square btn-ghost">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-6 h-6 stroke-current bg-white"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>
                            </label>
                        </div>
                        <div className="flex-1 px-2 mx-2 text-2xl font-mono text-white">Stella_TsuNami</div>
                        ...
                        <div className="flex-none hidden lg:block">
                            <ul className="menu menu-horizontal">
                                ...
                                <li><Link href="#Collection"  className="font-mono text-white">Collection</Link></li>
                                <li><Link href="#Contact" className="font-mono text-white">Contact</Link></li>
                            </ul>
                        </div>
                    </div>
                    <div>
                            ...
                            <div className="hero-content flex-col lg:flex-row">
                                ...
                                <div>
                                    ...
                                    <p className="py-6 text-primary">
                                        Introducing my beautiful Pugs, Stella and Tsunami,
                                        who will now live
